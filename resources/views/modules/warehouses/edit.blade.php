<x-splade-modal max-width="md">
    <div class="py-2 mt-3">
        <p class="font-medium text-center">Complete los datos para actualizar el almacen</p>
        <div class="px-2 py-1 mb-2 mb-5 border-b-2 border-gray-300"></div>
        <x-splade-form  action="{{ route('wr.update', [$warehouse]) }}" method="PATCH" :default="$warehouse">
