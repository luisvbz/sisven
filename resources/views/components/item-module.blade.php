<Link href="{{ $module->route }}"
    class="p-2 mb-2 transition duration-150 border border-gray-300 rounded-lg shadow-md cursor-pointer border-1 bg-gradient-to-b from-white to-gray-100 hover:white active:bg-gray-100 hover:scale-105 transform-gpu">
