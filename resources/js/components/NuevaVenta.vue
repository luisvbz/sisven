        ...
        <div class="flex space-x-3">
                ...
                <div class="bg-white p-4 rounded-md border border-gray-300 shadow-md flex flex-col divide-y-2 space-y-2">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <input type="text" readonly :value="totalByProduct(product, index)" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                    </div>
                </div>
                <!-- /lista de productos -->
            ...
            <div class="w-2/6">
                <div class=" flex flex-col space-y-2 bg-white p-4 rounded-md border border-gray-300 shadow-md">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <div class="bg-white absolute top-10 left-0 w-full rounded-md border border-gray-300 max-h-[250px] overflow-y-auto" v-if="clients.show">
                                ...
                                <div v-if="clients.data.length == 0 && queryClient != ''" class="flex justify-center items-center p-4 text-primary-500">
                                    No se ha conseguido el cliente..
                                </div>
                            </div>
                        </div>
                    ...
                    <div>
                        <button type="button" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">FINALIZAR VENTA</button>
                    </div>
                </div>
            </div>
        </div>
